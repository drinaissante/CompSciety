function About() {
    return (
        <div className="bg-[#e8ffd7] flex flex-col justify-center align-middle text-center p-5 gap-4 text-black">
            ...
            <p className="xs:text-lg xs:text-lg text-2xl w-[60ch] mx-auto">
            ...
            <div className="flex justify-center gap-4 m-10">
                <div className="bg-[#5e936c] lg:text-2xl  mt-5 rounded-2xl flex flex-col gap-3 p-10 text-white">
                    <span className="font-bold self-center">Mission</span>

                    <p className="w-lg break-after-auto text-center">
