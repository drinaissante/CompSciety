...
function About() {
  ...
  return (
    ...
    >
      <MotionDiv className="font-mono absolute -top-6 font-outfit font-bold text-4xl sm:text-5xl lg:text-6xl text-white sm:-top-9 sm:left-10">
        About CompSciety
      </MotionDiv>
      ...
      <MotionDiv className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-8 max-w-6xl w-full">
        ...
        <div className="flex flex-col max-w-3xl">
          <p className="font-mono m-5 sm:text-xl sm:m-0 text-white">
      ...
      {/* Learn More Btn */}
      <div className="cursor-pointer absolute -bottom-7 px-12 py-3 rounded-full text-lg font-bold text-white bg-linear-to-r from-green-400 to-blue-400 shadow-[0_0_7px_3px_rgba(0,255,0,0.6)] flex align-center hover:opacity-90 transition border" onClick={(e) => {
        e.preventDefault();
